...
public class TechnologyFragment extends Fragment {
    ...
    String country = "us";
    RecyclerView recyclerViewTechnologyFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.techonology_fragment, null);
        recyclerViewTechnologyFragment = v.findViewById(R.id.recyclerViewTechnologyFragment);
        modelClassList = new ArrayList<>();
        recyclerViewTechnologyFragment.setLayoutManager(new LinearLayoutManager(getContext()));
        fetchedAdapter = new FetchedAdapter(getContext(), modelClassList);
        recyclerViewTechnologyFragment.setAdapter(fetchedAdapter);
