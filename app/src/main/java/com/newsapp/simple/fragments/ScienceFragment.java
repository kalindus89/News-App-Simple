...
public class ScienceFragment extends Fragment {
    ...
    String country="us";
    RecyclerView recyclerViewScienceFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       View v =inflater.inflate(R.layout.science_fragment,null);
        recyclerViewScienceFragment=v.findViewById(R.id.recyclerViewScienceFragment);
        modelClassList = new ArrayList<>();
        recyclerViewScienceFragment.setLayoutManager(new LinearLayoutManager(getContext()));
        fetchedAdapter= new FetchedAdapter(getContext(),modelClassList);
        recyclerViewScienceFragment.setAdapter(fetchedAdapter);
