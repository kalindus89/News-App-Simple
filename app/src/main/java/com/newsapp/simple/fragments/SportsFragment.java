...
public class SportsFragment extends Fragment {
    ...
    String country = "us";
    RecyclerView recyclerViewSportsFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewSportsFragment = v.findViewById(R.id.recyclerViewSportsFragment);
        modelClassList = new ArrayList<>();
        recyclerViewSportsFragment.setLayoutManager(new LinearLayoutManager(getContext()));
        fetchedAdapter = new FetchedAdapter(getContext(), modelClassList);
        recyclerViewSportsFragment.setAdapter(fetchedAdapter);
