...
public class HealthFragment extends Fragment {
    ...
    String country="us";
    RecyclerView recyclerViewHealthFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewHealthFragment=v.findViewById(R.id.recyclerViewHealthFragment);
        modelClassList = new ArrayList<>();
        recyclerViewHealthFragment.setLayoutManager(new LinearLayoutManager(getContext()));
        fetchedAdapter= new FetchedAdapter(getContext(),modelClassList);
        recyclerViewHealthFragment.setAdapter(fetchedAdapter);
